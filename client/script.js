...
const sayHello = () => {
    axios.get('http://localhost:3000/say-hello').then((res) => {
        ...
        helloText.style.backgroundColor = 'blue';
...
const ohMy = () => {
    /* YOUR CODE HERE*/ return axios.get('http://localhost:3000/animals')
    .then (function(res) {
...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/test').then(function(res) {
...
// CODE HERE
const query = () => {
axios.get('http://localhost:3000/query-test?Nates-query=I-Love-Lego&My-Second-query=I-Love-Code')
...
// Edit code in Problem 8
 //1. Sent an empty query!
//2. Sent more than 1 query! and shows them both in drop down menu
